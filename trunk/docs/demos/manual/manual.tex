...
\paragraph{Step 3.}
Compile {\fontsize{10pt}{10pt}\verb!mydoc.tex!} with {\fontsize{10pt}{10pt}\verb!latex -shell-escape!} 
...
\end{Verbatim}
The {\fontsize{10pt}{10pt}\verb!-shell-escape!} option is required because {\fontsize{10pt}{10pt}\verb!ptex2tex!} inserts an include
of the {\fontsize{10pt}{10pt}\verb!minted.sty!} style, which applies the {\fontsize{10pt}{10pt}\verb!pygments!} to format code,
and this program cannot be run from {\fontsize{10pt}{10pt}\verb!latex!} without the {\fontsize{10pt}{10pt}\verb!-shell-escape!} option.
