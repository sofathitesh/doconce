...
\begin{center}
{\small ${}^1$University of Oslo} \\ [-1.0mm]
\end{center}

\begin{center}
{\small ${}^2$Simula Research Laboratory} \\ [-1.0mm]
\end{center}
...
\begin{itemize}
   ...
   \item Use {\fontsize{10pt}{10pt}\verb!#include!} statements in source code (especially in doc
     ...
     appropriate format by the program {\fontsize{10pt}{10pt}\verb!doconce!} before being
...
the {\fontsize{10pt}{10pt}\verb!doc1!} documentation includes code snippets with doc strings
with the usual triple double quotes): {\fontsize{10pt}{10pt}\verb!#  #include docstrings/doc1.dst.txt!}.
...
\begin{figure}
  \centerline{\includegraphics[width=0.9\linewidth]{figs/dinoimpact.eps}}
  \caption{
...
feature works only for the {\fontsize{10pt}{10pt}\verb!LaTeX!} and {\fontsize{10pt}{10pt}\verb!HTML!} formats.
\begin{Verbatim}[fontsize=\fontsize{9pt}{9pt},tabsize=8,baselinestretch=0.85,
fontfamily=tt,xleftmargin=7mm]
...
\begin{center}
\includemovie[poster,
label=figs/demo.mpeg,
autoplay,
controls,
toolbar,
text={\small (Loading figs/demo.mpeg)},
repeat,
]{0.9\linewidth}{0.9\linewidth}{figs/demo.mpeg}    % requires \usepackage{movie15}
\movieref[rate=0.5]{figs/demo.mpeg}{Slower}
\movieref[rate=2]{figs/demo.mpeg}{Faster}
\movieref[default]{figs/demo.mpeg}{Normal}
\movieref[pause]{figs/demo.mpeg}{Play/Pause}
\movieref[stop]{figs/demo.mpeg}{Stop}
\end{center}
\caption{}
\end{figure}
...
{\fontsize{10pt}{10pt}\verb!myframes*.png!}. In that case, a player for showing the sequence of frames
...
Note: {\fontsize{10pt}{10pt}\verb!idx!} commands should be inserted outside paragraphs, not in between
...
(\href{http://code.google.com/p/preprocess}{http://code.google.com/p/preprocess}) and Mako
(\href{http://www.makotemplates.org/}{http://www.makotemplates.org/}). The former allows include and if-else
...
Preprocess and Mako always have the variable {\fontsize{10pt}{10pt}\verb!FORMAT!} to be the desired
output format of Doconce. It is then easy to test on the value of {\fontsize{10pt}{10pt}\verb!FORMAT!}
...
running {\fontsize{10pt}{10pt}\verb!doconce format!}, the reason for the error is most likely a
