...
<P>
<IMG SRC="../docs/manual/figs/dinoimpact.gif" ALIGN="bottom"  width=200> <P><EM> It can't get worse than this.... <A NAME="fig:impact"></A></EM></P>
...
\begin{figure}
  \centerline{\includegraphics[width=0.9\linewidth]{../docs/manual/figs/dinoimpact.eps}}
  \caption{
...
<CENTER><H3>Mar 22, 2011</H3></CENTER>
<P>
...
<CENTER>Tue, 22 Mar 2011 (09:31)</CENTER>
...
<P>
<!-- PDF does not support movies everywhere -->
<EMBED SRC="figs/demo.mpeg"  width=600, height=470 AUTOPLAY="TRUE" LOOP="TRUE"></EMBED> <P><EM></EM></P>
...
<wiki:comment> PDF does not support movies everywhere </wiki:comment>
MOVIE: [figs/demo.mpeg, width=600, height=470]
