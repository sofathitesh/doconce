...
<P>
<IMG SRC="../docs/manual/figs/dinoimpact.gif"  width=200> It can't get worse than this.... <A NAME="fig:impact"></A>
...
<wiki:comment> 
Put the figure file ../docs/manual/figs/dinoimpact.gif on the web and write the
...
[http://yourproject.googlecode.com/svn/.../../docs/manual/figs/dinoimpact.gif
http://yourproject.googlecode.com/hg/.../../docs/manual/figs/dinoimpact.gif
 /wiki:comment]
---------------------------------------------------------------
...
FIGURE:[../docs/manual/figs/dinoimpact.gif, width=200] It can't get worse than this.... 
Table Demo
Let us take this table from the manual:
...
<CENTER>Thu, 09 Sep 2010 (15:56)</CENTER>
