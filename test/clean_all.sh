...
echo "NOTE: The source is removed in reinstalled from svn!!"
...
cd ..
rm -rf build
svn commit -m 'ensure last changes are recorded'
echo 'if svn commit was successful, run these three commands manually:'
echo 'cd ..'
echo 'rm -rf lib bin'
echo 'svn update'
