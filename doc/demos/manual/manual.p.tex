...
\code{block}, \code{warning}, \code{notice}, \code{hint}, \code{question}, and \code{summary}.
The box is defined by begin and end tags such as \code{!bhint} and \code{!ehint}.
...
\begin{itemize}
 ...
 \item \code{--html_admon=yellow}, \code{--html_style=bluish2}, \code{--no_pygments_html}

 \item \code{--html_admon=yellow}, \code{--html_style=blueish2}, \code{--pygments_html_style=default}

 \item \code{--html_admon=gray}, \code{--html_style=bloodish}, \code{--no_pygments_html}

 \item \code{--html_admon=gray}, \code{--html_style=bloodish}, \code{--pygments_html_style=default}
