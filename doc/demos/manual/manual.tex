...
% One possible way from Doconce to MS Word goes via {\fontsize{10pt}{10pt}\verb!latex!} and then
% {\fontsize{10pt}{10pt}\verb!texmacs!}. This didn't work well for math and figures.
