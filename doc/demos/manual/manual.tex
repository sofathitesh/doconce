...
data structure (list of dictionaries) stored in a file {\fontsize{10pt}{10pt}\verb!.mydoc.exerinfo!},
if {\fontsize{10pt}{10pt}\verb!mydoc.do.txt!} is the name of the Doconce file.
