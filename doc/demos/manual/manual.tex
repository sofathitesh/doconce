...
Other preprocessor variables are {\fontsize{10pt}{10pt}\verb!BOOK!} for the "book" documentclass
rather than the standard "article" (necessary if you apply chapter
headings), {\fontsize{10pt}{10pt}\verb!PALATINO!} for the palatino font, {\fontsize{10pt}{10pt}\verb!A4PAPER!} for A4 paper
size, {\fontsize{10pt}{10pt}\verb!A6PAPER!} for A6 paper size (suitable for reading on small
devices), {\fontsize{10pt}{10pt}\verb!MOVIE15!} for inclusion of the movie15 {\LaTeX} package,
{\fontsize{10pt}{10pt}\verb!PREAMBLE!} to turn the {\LaTeX} preamble on or off,
and
{\fontsize{10pt}{10pt}\verb!MINTED!} for inclusion of the minted package (which requires {\fontsize{10pt}{10pt}\verb!latex!}
