...
\end{Verbatim}
The name of the output file is {\fontsize{10pt}{10pt}\verb!mydoc.pnd!}.
...
document.  One can either run {\fontsize{10pt}{10pt}\verb!automake-sphinx.sh!} or perform the
...
directories, {\fontsize{10pt}{10pt}\verb!automake-sphinx.sh!} must be edited accordingly.
