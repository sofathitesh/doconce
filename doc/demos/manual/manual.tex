...
specified as \Verb!--html-style=name!, where \Verb!name! can be
...
Pygments style is set by \Verb!--pygments-html-style=style!, where \Verb!style!
...
\begin{itemize}
 \item \Verb!BOOK! for the "book" documentclass rather than the standard
   "article" class (necessary if you apply chapter headings with 9 \Verb!=!)
...
your own preamble by adding the command-line option \Verb!--latex-preamble=myfile!.
...
BIBFILE: papers.pub
\end{Verbatim}
In {\LaTeX} and \textsc{pdf}{\LaTeX} the \Verb!papers.pub! file is exported to BibTeX format
...
the command-line option \Verb!--examples-as-exercises!. That is, without
...
With the command-line option \Verb!--examples-as-exercises!,
...
something goes wrong in this stage (i.e., when \Verb!mako! and
...
option \Verb!--examples-as-exercises!. The text in the example is typeset
