...
\begin{itemize}
 \item \code{XETEX} for processing by \code{xelatex}

 \item \code{LATEX_HEADING} for the typesetting of the title, author, etc.
...
\code{disable}, \code{todonotes}, \code{lineno}, \code{xr}, \code{movie15}, \code{a4paper}, and
\code{a6paper}.
...
\code{tkdiff.tcl}                                                                         & \href{{https://sourceforge.net/projects/tkdiff/}}{tkdiff}                                      & \code{sudo apt-get install not in Debian}                                                 \\
\hline
\end{tabular}\end{quote}
