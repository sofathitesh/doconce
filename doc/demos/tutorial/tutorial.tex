...
\begin{itemize}
 ...
 \item {\fontsize{10pt}{10pt}\Verb!AMON!} for setting the type of admonitions: {\fontsize{10pt}{10pt}\Verb!"colors"!} for colored
   boxes with icons, {\fontsize{10pt}{10pt}\Verb!"graybox1"!} for gray frame boxes with rounded
   corners (default), {\fontsize{10pt}{10pt}\Verb!"graybox2"!} for narrower square gray frame boxes
   (except for summary, which for A4 format is small and with wrapped
   text around if it does not contain verbatim code),
   or {\fontsize{10pt}{10pt}\Verb!"paragraph"!} for simple, plain paragraph headings and ordinary text
