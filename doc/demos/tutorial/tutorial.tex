...
\subsection{Basic Syntax Examples}
...
Doconce also allows inline comments such as \shortinlinecomment{hpl}{here I will make
some remarks to the text}{here I will make some remarks to the text} for allowing authors to make notes. Inline
...
specified as {\fontsize{10pt}{10pt}\Verb!--html-style=name!}, where {\fontsize{10pt}{10pt}\Verb!name!} can be
...
Pygments style is set by {\fontsize{10pt}{10pt}\Verb!--pygments-html-style=style!}, where {\fontsize{10pt}{10pt}\Verb!style!}
...
\begin{itemize}
 \item {\fontsize{10pt}{10pt}\Verb!BOOK!} for the "book" documentclass rather than the standard
   "article" class (necessary if you apply chapter headings with 9 {\fontsize{10pt}{10pt}\Verb!=!})
